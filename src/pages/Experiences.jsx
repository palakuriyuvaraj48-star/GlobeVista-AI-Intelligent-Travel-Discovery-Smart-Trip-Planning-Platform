...
export default function ExperiencesPage() {
  ...
  const filteredExperiences = experiences.filter(exp => {
    ...
    const priceMatch = priceRange === 'all' || 
      (priceRange === 'budget' && exp.price < 200) ||
      (priceRange === 'mid' && exp.price >= 200 && exp.price < 300) ||
      (priceRange === 'premium' && exp.price >= 300)
      ...
      >
        ...
        <Card className="p-6 mb-8">
          <div className="flex flex-wrap items-center gap-6">
            ...
            <div>
              <h4 className="font-medium mb-2">{t('experiences.category')}</h4>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredExperiences.map(exp => (
            <Card key={exp.id} className="overflow-hidden group hover:shadow-2xl transition-all duration-300">
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Link to={`/booking`}>
                      <Button size="sm">{t('experiences.bookNow')}</Button>
                    </Link>
                  </div>
                </div>
              </div>
